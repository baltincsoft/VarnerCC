var App = function () {
    ...
    var handleLoginForm = function () {
		...
		jQuery('#register-forgot-btn').click(function () {
            jQuery('.login-form').hide();
    ...
    var handleTables = function () {
        ...
        jQuery('#ocrTable_wrapper .dataTables_filter input').addClass("m-wrap large"); // modify table search input
        jQuery('#ocrTable_wrapper .dataTables_length select').addClass("m-wrap xsmall"); // modify table per page dropdown
        ...
        jQuery('#prTable_wrapper .dataTables_filter input').addClass("m-wrap large"); // modify table search input
        jQuery('#prTable_wrapper .dataTables_length select').addClass("m-wrap xsmall"); // modify table per page dropdown
    ...
    var handleEditableTables = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[1].innerHTML = '<a class="edit" onClick="" href="">Save</a>';
        ...
        function saveRow(oTable, nRow) {
            ...
            oTable.fnUpdate('<a class="delete" onClick="" href="">Delete</a>', nRow, 2, false);
            oTable.fnDraw();
        }
