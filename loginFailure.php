...
<body class="login">
  ...
  <div class="content">
    <!-- BEGIN BHANU FORM -->
    <form class="form-vertical login-form" method="POST" action="System/">
      <h3 class="form-title">Login to your account</h3>
	  <div class="alert alert-error">
        <button class="close" data-dismiss="alert"></button>
        <span>Email/Password does not match with our records.Please try again.</span>
      </div>
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-user"></i>
            <input class="m-wrap placeholder-no-fix" type="email" placeholder="Email" id="username" name="username"/>
          </div>
        </div>
      </div>
      <div class="control-group">
      ...
      <div class="create-account">
             <a href="http://varnercc.com" >Go to Home Page</a>
      </div>
