...
<head>
   ...
   <link rel="stylesheet" href="{$SERVER_ACTUAL_PATH}assets/data-tables/DT_bootstrap.css" />
...
<body class="fixed-top">
   ...
   <div class="page-container row-fluid">
      ...
      <div class="page-sidebar nav-collapse collapse">
         ...
         <ul>
			...
			<li class="start {$dshbrd_active}">
                <a href="{$SERVER_ACTUAL_PATH}Dashboard">
                <i class="icon-user"></i>
            ...
            <li class="{$emplyr_active}">
                {if $EmployeeID>0}
                    <a href="{$SERVER_ACTUAL_PATH}Employer-Detail">
                    <i class="icon-home"></i>
            ...
            <li class="{$lgl_active}">
                {if $EmployeeID>0}
                    <a href="{$SERVER_ACTUAL_PATH}Legal-Detail">
            ...
            <li class="{$npd_active}">
                {if $EmployeeID>0}
                    <a href="{$SERVER_ACTUAL_PATH}Non-ProfitDetail">
                    <i class="icon-table"></i> 
            ...
            <li class="{$addnl_active}">
                {if $EmployeeID>0}
                    <a href="{$SERVER_ACTUAL_PATH}Additional-Detail">
                        <i class="icon-table"></i> 
			...
			<li class="">
                <a href="{$SERVER_ACTUAL_PATH}Add-New-Insured-Employee">
                <i class="icon-user"></i>
			...
			{if $IsAdmin==1}
				<li class="">
					<a href="{$SERVER_ACTUAL_PATH}ExportFile">
            ...
            <div class="row-fluid">
               <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i>
                            <a href="{$SERVER_ACTUAL_PATH}System">Home</a>
                            ...
                            <div>
                                <table width='100%' align='center'>
                                    ...
                                    <tr class='cl-container-tr-row'>
                                        ...
                                        <td style="width:24%">
                                            <a href='#' class="btn green" onClick='javascript:addNewLog({$EmployeeID});'>Add New Log</a>
                                        </td>
                                    </tr>
                                </table>
                            </div>
   ...
   <![endif]-->
	...
	<script type="text/javascript" src="{$SERVER_ACTUAL_PATH}assets/data-tables/jquery.dataTables.js"></script>
	<script type="text/javascript" src="{$SERVER_ACTUAL_PATH}assets/data-tables/DT_bootstrap.js"></script>
