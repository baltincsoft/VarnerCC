        ...
        <div class="active tab-pane ">
            <div class="portlet box red">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Add/Edit Legal Details</h4>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    ...
                    <form id="add-LegalDetails" method="POST" class="form-horizontal" action="{$SERVER_ACTUAL_PATH}System/">
                        ...
                        <div class="row-fluid">
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12 phone" maxlength="13" id="IEPhone" name="IEPhone" value="{$IEABusinessPhone}" onCopy="return false" onPaste="return false" autocomplete="off"> 
                                    </div>
                                </div>
                           </div>
                           <div class="span5">
                        ...
                        <div class="row-fluid">
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12 phone" maxlength="13" id="IEFax" name="IEFax" value="{$IEAFaxNumber}" onCopy="return false" onPaste="return false" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                        ...
                        <div class="row-fluid">
                            <div class="span5">
                                <div class="control-group">
                                    <label class="control-label">Business Phone</label>
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12 phone" maxlength="13" id="DAPhone" name="DAPhone" value="{$DABusinessPhone}" onCopy="return false" onPaste="return false" autocomplete="off"/> 
                                    </div>
                                </div>
                           </div>
                           <!--/span-->
                        ...
                        <div class="row-fluid">
                           <div class="span5">
                                  <div class="control-group">
                                         <label class="control-label">Fax Number</label>
                                         <div class="controls">
                                                <input type="text" class="m-wrap span12 phone" maxlength="13" id="DAFax" name="DAFax" value="{$DAFaxNumber}" onCopy="return false" onPaste="return false" autocomplete="off"/>
                                         </div>
                                  </div>
                           </div>
                           <!--/span-->
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn blue pull-right" ><i class="icon-ok"></i> Add Legal Details</button>
                        </div>
