        ...
        <div class="active tab-pane ">
            <div class="portlet box green">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Add/Edit Employer Details</h4>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    ...
                    <h3 class="form-section">General Information</h3>								 
                        ...
                        <div class="row-fluid">
                           <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12 phone" name="eR_FaxNumber" id="eR_FaxNumber" maxlength="13" value="{$GIEReferralSource}"> 
                                    </div>
                                </div>
                           </div>
                           <!--/span-->
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn blue pull-right" ><i class="icon-ok"></i> Add Employer Details</button>
                        </div>
