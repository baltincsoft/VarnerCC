...
{block name="body"}
<div id="ADD-NPAJAXADD">
<div class="span12">
    <div class="tab-content">
        <div class="active tab-pane ">
            <div class="portlet box red">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Add/Edit Non-Profit Details</h4>
                    <div class="tools">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12 phone" {$makeRed} name="nppcPhone" id="nppcPhone" maxlength="13" value="{$NPPCPhone}" />
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12 phone" {$makeRed} name="nppcFax" id="nppcFax" maxlength="13" value="{$NPPCFax}" />
                                    </div>
                                </div>
                            </div>
                           <!--/span-->
                        ...
                        <div class="row-fluid">
                            <div class="span5">
                                <div class="control-group">
                                    <label class="control-label">Phone</label>
                                    <div class="controls">
                                        <input type="text" id="sPhone" name="sPhone" maxlength="13" class="m-wrap span12 phone" placeholder="Phone Number" value="{$NPSCPhone}" /> 
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
