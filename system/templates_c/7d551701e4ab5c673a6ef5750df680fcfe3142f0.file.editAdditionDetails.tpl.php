<?php /* Smarty version Smarty 3.1.4, created on 2015-06-27 15:14:48
         compiled from ".\templates\editAdditionDetails.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8817558f2058076e47-70223702%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d551701e4ab5c673a6ef5750df680fcfe3142f0' => 
    array (
      0 => '.\\templates\\editAdditionDetails.tpl',
      1 => 1435440075,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8817558f2058076e47-70223702',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_558f205920f95',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_558f205920f95')) {function content_558f205920f95($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="active tab-pane ">
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    ...
                    <!-- BEGIN FORM-->
                    <form id="add-AdditionalDetails" method="POST" class="form-horizontal" action="<?php echo $_smarty_tpl->tpl_vars['SERVER_ACTUAL_PATH']->value;?>
System/">
                                    ...
                                    <div class="controls">
                                        <div class="input-group">
                                            <div class="input-append date date-picker" data-date="today();" data-date-format="mm/dd/yyyy" data-date-viewmode="days">
                                                <?php if ($_smarty_tpl->tpl_vars['ADDropOffDate']->value!="00/00/0000"){?>
                                                    <input id="aDropOffDate" name="aDropOffDate" value="<?php echo $_smarty_tpl->tpl_vars['ADDropOffDate']->value;?>
" class="m-wrap m-ctrl-medium form-control span12" size="16" type="text" placeholder="MM/DD/YYYY"/>
                                                <?php }else{ ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="m-wrap span12" name="aShippingVendor" id="aShippingVendor">
                                            <option value="FED" <?php echo $_smarty_tpl->tpl_vars['FED_SELECTED']->value;?>
>FedEx</option>
                                            <option value="UPS" <?php echo $_smarty_tpl->tpl_vars['UPS_SELECTED']->value;?>
>UPS</option>
                                            <option value="USP" <?php echo $_smarty_tpl->tpl_vars['USP_SELECTED']->value;?>
>USPS</option>
                                            <option value="OTH" <?php echo $_smarty_tpl->tpl_vars['OTH_SELECTED']->value;?>
>Other</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row-fluid">
                           <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="m-wrap span12" placeholder="Tracking Number" name="aTrackingNumber" id="aTrackingNumber" value="<?php echo $_smarty_tpl->tpl_vars['ADTrackingNumber']->value;?>
"/>                             
                                    </div>
                                </div>
                           </div>
                           ...
                           <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <a href="https://www.google.com?TrackingNumber=<?php echo $_smarty_tpl->tpl_vars['ADTrackingNumber']->value;?>
" class="m-wrap span12" name="aCheckStatus" id="aCheckStatus" target="_blank">Tracking</a>
                                    </div>
                                </div>
                           </div>
                           <!--/span-->
                        ...
                        <div class="row-fluid">
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append date date-picker" data-date="today();" data-date-format="mm/dd/yyyy" data-date-viewmode="days">
                                            <?php if ($_smarty_tpl->tpl_vars['ADDateDelivered']->value!="00/00/0000"){?>
                                                <input id="aDateDelievered" name="aDateDelievered" value="<?php echo $_smarty_tpl->tpl_vars['ADDateDelivered']->value;?>
" class="m-wrap m-ctrl-medium form-control span12" size="16" type="text" placeholder="MM/DD/YYYY"/>
                                            <?php }else{ ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append bootstrap-timepicker-component">
                                            <input name="aTimeDelievered" id="aTimeDelievered" value="<?php echo $_smarty_tpl->tpl_vars['ADDeliveredTime']->value;?>
" class="m-wrap m-ctrl-small timepicker-default" type="text" placeholder="Time Delivered" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="m-wrap span12" name="aUnbeliverable" id="aUnbeliverable" >
                                            ...
                                            <option value="Y" <?php echo $_smarty_tpl->tpl_vars['Y_SELECTED']->value;?>
>Yes</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row-fluid">
                            <div class="span10">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="m-wrap span12" name="aReason" id="aReason"><?php echo $_smarty_tpl->tpl_vars['ADReason']->value;?>
</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['ADFU_QTNP']->value==1){?>
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-group">
                                            <div class="input-append date date-picker" data-date="today();" data-date-format="mm/dd/yyyy" data-date-viewmode="days">
                                                <?php if ($_smarty_tpl->tpl_vars['ADFU_QTNP_Date']->value!="00/00/0000"){?>
                                                    <input id="aquesNPDate" name="aquesNPDate" value="<?php echo $_smarty_tpl->tpl_vars['ADFU_QTNP_Date']->value;?>
" class="m-wrap m-ctrl-medium form-control span12" size="16" type="text" placeholder="MM/DD/YYYY"/>
                                                <?php }else{ ?>
                        ...
                        <div class="row-fluid">
                            <div class="span5">
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="checkbox">
                                        <?php if ($_smarty_tpl->tpl_vars['ADFU_QTE']->value==1){?>
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-group">
                                            <div class="input-append date date-picker" data-date="today();" data-date-format="mm/dd/yyyy" data-date-viewmode="days">
                                                <?php if ($_smarty_tpl->tpl_vars['ADFU_QTE_Date']->value!="00/00/0000"){?>
                                                    <input id="aQuesEmpDate" name="aQuesEmpDate" value="<?php echo $_smarty_tpl->tpl_vars['ADFU_QTE_Date']->value;?>
                        ...
                        <div class="row-fluid">
                            <div class="span5">
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="checkbox">
                                        <?php if ($_smarty_tpl->tpl_vars['ADFU_SOC']->value==1){?>
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-group">
                                            <div class="input-append date date-picker" data-date="today();" data-date-format="mm/dd/yyyy" data-date-viewmode="days">
                                                <?php if ($_smarty_tpl->tpl_vars['ADFU_SOC_Date']->value!="00/00/0000"){?>
                                                    <input id="aQADate" name="aQADate" value="<?php echo $_smarty_tpl->tpl_vars['ADFU_SOC_Date']->value;?>
" class="m-wrap m-ctrl-medium form-control span12" size="16" type="text" placeholder="MM/DD/YYYY"/><span class="add-on"><i class="icon-calendar"></i></span>
                                                <?php }else{ ?>
